							...
							<div class="text-right">
								...
								<div class="btn-group btn-group-sm">
									...
									<ul class="dropdown-menu dropdown-menu-right" role="menu">
										<li><a href="#" data-toggle="modal" data-target="#dialog_srvAssist">{$MLANG.client_srvassistant}</a>
										</li>
									</ul>
									{/if}
								</div>
				...
				<div role="tabpanel" class="tab-pane" id="dnssec">
					<div class="table-container clearfix">
						...
						<table width="100%" class="table table-list" border="0" cellspacing="1" cellpadding="3">
							<tr>
								<th align="center" width="10%"><strong>{$MLANG.client_keytag}</strong>
								</th>
								<th align="center" width="20%"><strong>{$MLANG.client_flag}</strong>
								</th>
								<th align="center" width="20%"><strong>{$MLANG.client_algorithm}</strong>
								</th>
								<th align="center" width="50%"><strong>{$MLANG.client_publickey}</strong>
								</th>
							</tr>
							{if $dnssec_keys}
						...
						<table width="100%" class="table table-list" border="0" cellspacing="1" cellpadding="3">
							<tr>
								...
								<th align="center" width="20%"><strong>{$MLANG.client_digesttype}</strong>
								</th>
								<th align="center" width="50%"><strong>{$MLANG.client_digest}</strong>
								</th>
							</tr>
							{if $dnssec_keys}
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-2">
								...
								{else}
								<input type="text" class="form-padding form-control" name="sdns_ttl_0" id="sdns_ttl_0"> {/if}
							</div>
						</div>
					</div>
